...
import {getDataForChartElement, getReChartDataFromConfig} from "@/components/relation/chart/rechart/utils";
                                            ...
                                            <>
                                                {   // we need to call the Custom components like this because of rechart madness
                                                    ...
                                                    ChartDataElement({
                                                        ...
                                                        axis: axis,
                                                        elementData: getDataForChartElement(axis, data, config.plot.type),
                                                    })
                                                }
                                            </>
                                        ))
