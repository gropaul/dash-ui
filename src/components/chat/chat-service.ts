...
export interface ChatService {
   ...
   */
  sendMessage(content: string, options?: SendMessageOptions): Promise<ChatServiceResponse>;
...
export class MockChatService implements ChatService {
  ...
  async sendMessage(content: string, options?: SendMessageOptions): Promise<ChatServiceResponse> {
